...
class Ui_ShibumiDisplay(object):
    def setupUi(self, ShibumiDisplay):
        ...
        self.grid_layout.addWidget(self.move_black, 5, 1, 1, 3)
        ...
        self.grid_layout.addWidget(self.move_white, 5, 4, 1, 3)
        ...
        self.grid_layout.addWidget(self.move_red, 6, 1, 1, 3)

        self.game_display = QGraphicsView(ShibumiDisplay)
        self.game_display.setObjectName(u"game_display")

        self.grid_layout.addWidget(self.game_display, 0, 0, 7, 1)
        ...
        self.grid_layout.addWidget(self.remove, 6, 4, 1, 3)
